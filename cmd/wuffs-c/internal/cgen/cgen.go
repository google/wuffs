...
func genBase() ([]byte, error) {
	b := make(buffer, 0, 128*1024)
	for s := baseImplC; ; {
		remaining := ""
		...
		if !strings.HasPrefix(s, "// !! ") {
			...
			switch s {
			default:
				return nil, fmt.Errorf("unrecognized base-impl.c line %q", s)

			case "// !! base-public.h goes here.\n":
				b.writes("// Code generated by wuffs-c. DO NOT EDIT.\n\n")
				b.writes(basePublicH)
				b.writeb('\n')

			case "// !! wuffs_base__status__string data goes here.\n":
				// TODO.
			}
		}
