...
const writerWantILAEnd = "" +
	...
	"00000020  99 75 01 ff 00 00 00 00  00 00 00 ff 00 00 00 00  |.u..............|\n" +
	"00000030  00 00 00 ff 11 00 00 00  00 00 00 ff 33 00 00 00  |............3...|\n" +
	"00000040  00 00 00 01 77 00 00 00  00 00 00 ee 04 00 00 00  |....w...........|\n" +
	"00000050  00 00 00 ff 07 00 00 00  00 00 00 ff 09 00 00 00  |................|\n" +
	"00000060  00 00 00 ff 0c 00 00 00  00 00 00 00 10 00 00 00  |................|\n" +
	"00000070  00 00 00 00 7c 00 00 00  00 00 00 05              |....|.......|\n"

const writerWantILAStart = "" +
	"00000000  72 c3 63 05 38 ec 01 ff  00 00 00 00 00 00 00 ff  |r.c.8...........|\n" +
	"00000010  00 00 00 00 00 00 00 ff  11 00 00 00 00 00 00 ff  |................|\n" +
	"00000020  33 00 00 00 00 00 00 01  77 00 00 00 00 00 00 ee  |3.......w.......|\n" +
	"00000030  60 00 00 00 00 00 00 ff  63 00 00 00 00 00 00 ff  |`.......c.......|\n" +
	"00000040  65 00 00 00 00 00 00 ff  68 00 00 00 00 00 00 00  |e.......h.......|\n" +
	"00000050  6c 00 00 00 00 00 00 00  78 00 00 00 00 00 00 05  |l.......x.......|\n" +
