...
static const uint8_t wuffs_flate__code_order[19] = {
    16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15,
};

static const uint8_t wuffs_flate__reverse8[256] = {
...
static const uint32_t wuffs_flate__lcode_magic_numbers[32] = {
...
static const uint32_t wuffs_flate__dcode_magic_numbers[32] = {
...
void wuffs_flate__adler32__initialize(wuffs_flate__adler32* self,
                                      uint32_t wuffs_version,
                                      uint32_t for_internal_use_only);

// ---------------- Private Function Prototypes

static wuffs_flate__status wuffs_flate__flate_decoder__decode_blocks(
    wuffs_flate__flate_decoder* self,
    wuffs_base__writer1 a_dst,
    wuffs_base__reader1 a_src);

static wuffs_flate__status wuffs_flate__flate_decoder__decode_uncompressed(
    wuffs_flate__flate_decoder* self,
    wuffs_base__writer1 a_dst,
    wuffs_base__reader1 a_src);

static wuffs_flate__status wuffs_flate__flate_decoder__init_fixed_huffman(
    wuffs_flate__flate_decoder* self);

static wuffs_flate__status wuffs_flate__flate_decoder__init_dynamic_huffman(
    wuffs_flate__flate_decoder* self,
    wuffs_base__reader1 a_src);

static wuffs_flate__status wuffs_flate__flate_decoder__init_huff(
    wuffs_flate__flate_decoder* self,
    uint32_t a_which,
    uint32_t a_n_codes0,
    uint32_t a_n_codes1,
...
static wuffs_flate__status wuffs_flate__flate_decoder__decode_huffman_slow(
    wuffs_flate__flate_decoder* self,
    wuffs_base__writer1 a_dst,
    wuffs_base__reader1 a_src);

static uint32_t wuffs_flate__adler32__update(wuffs_flate__adler32* self,
...
void wuffs_flate__flate_decoder__initialize(wuffs_flate__flate_decoder* self,
  ...
  if (wuffs_version != WUFFS_VERSION) {
    self->private_impl.status = WUFFS_FLATE__ERROR_BAD_WUFFS_VERSION;
    return;
  }
...
void wuffs_flate__zlib_decoder__initialize(wuffs_flate__zlib_decoder* self,
  ...
  wuffs_flate__adler32__initialize(&self->private_impl.f_adler, WUFFS_VERSION,
...
wuffs_flate__status wuffs_flate__flate_decoder__decode(
    ...
    wuffs_base__reader1 a_src) {
  if (!self) {
    return WUFFS_FLATE__ERROR_BAD_RECEIVER;
  }
  if (self->private_impl.magic != WUFFS_BASE__MAGIC) {
    self->private_impl.status = WUFFS_FLATE__ERROR_INITIALIZER_NOT_CALLED;
  }
  ...
  switch (coro_susp_point) {
    ...
    while (true) {
      wuffs_base__writer1__mark(&a_dst, b_wptr_dst);
      {
        ...
        wuffs_flate__status t_0 =
            wuffs_flate__flate_decoder__decode_blocks(self, a_dst, a_src);
        if (a_dst.buf) {
          b_wptr_dst = a_dst.buf->ptr + a_dst.buf->wi;
        }
        v_z = t_0;
  ...
  label_0_continue:;
    while (v_final == 0) {
      ...
      if (v_type == 0) {
        ...
        status =
            wuffs_flate__flate_decoder__decode_uncompressed(self, a_dst, a_src);
        if (a_src.buf) {
          b_rptr_src = a_src.buf->ptr + a_src.buf->ri;
        }
        if (status) {
        ...
        status = wuffs_flate__flate_decoder__init_fixed_huffman(self);
        if (status) {
          goto suspend;
        }
      } else if (v_type == 2) {
        ...
        status = wuffs_flate__flate_decoder__init_dynamic_huffman(self, a_src);
        if (a_src.buf) {
          b_rptr_src = a_src.buf->ptr + a_src.buf->ri;
        }
        if (status) {
        ...
        status = WUFFS_FLATE__ERROR_BAD_FLATE_BLOCK;
        goto exit;
      }
      ...
      status =
          wuffs_flate__flate_decoder__decode_huffman_slow(self, a_dst, a_src);
      if (a_src.buf) {
        b_rptr_src = a_src.buf->ptr + a_src.buf->ri;
      }
      if (status) {
      ...
      status =
          WUFFS_FLATE__ERROR_INTERNAL_ERROR_INCONSISTENT_HUFFMAN_END_OF_BLOCK;
      goto exit;
    }
...
short_read_src:
  if (a_src.buf && a_src.buf->closed && !a_src.private_impl.limit.ptr_to_len) {
    status = WUFFS_FLATE__ERROR_UNEXPECTED_EOF;
    goto exit;
  }
  status = WUFFS_FLATE__SUSPENSION_SHORT_READ;
  goto suspend;
}
...
static wuffs_flate__status wuffs_flate__flate_decoder__decode_uncompressed(
  ...
  switch (coro_susp_point) {
    ...
    if ((self->private_impl.f_n_bits >= 8) ||
      ...
      status = WUFFS_FLATE__ERROR_INTERNAL_ERROR_INCONSISTENT_N_BITS;
      goto exit;
    }
    ...
    if ((((v_length) & ((1 << (16)) - 1)) + ((v_length) >> (32 - (16)))) !=
        65535) {
      status = WUFFS_FLATE__ERROR_INCONSISTENT_STORED_BLOCK_LENGTH;
      goto exit;
    }
    ...
    while (true) {
      ...
      if (((uint64_t)(b_wend_dst - b_wptr_dst)) == 0) {
        status = WUFFS_FLATE__SUSPENSION_SHORT_WRITE;
...
static wuffs_flate__status wuffs_flate__flate_decoder__init_fixed_huffman(
  ...
  switch (coro_susp_point) {
    ...
    WUFFS_BASE__COROUTINE_SUSPENSION_POINT(1);
    status = wuffs_flate__flate_decoder__init_huff(self, 0, 0, 288, 257);
    if (status) {
      goto suspend;
    }
    WUFFS_BASE__COROUTINE_SUSPENSION_POINT(2);
    status = wuffs_flate__flate_decoder__init_huff(self, 1, 288, 320, 0);
    if (status) {
      goto suspend;
    }
...
static wuffs_flate__status wuffs_flate__flate_decoder__init_dynamic_huffman(
  ...
  switch (coro_susp_point) {
    ...
    if (v_n_lit > 286) {
      status = WUFFS_FLATE__ERROR_BAD_LITERAL_LENGTH_CODE_COUNT;
      goto exit;
    }
    v_bits >>= 5;
    v_n_dist = (((v_bits) & ((1 << (5)) - 1)) + 1);
    if (v_n_dist > 30) {
      status = WUFFS_FLATE__ERROR_BAD_DISTANCE_CODE_COUNT;
      goto exit;
    }
    v_bits >>= 5;
    ...
    while (v_i < v_n_clen) {
      ...
      self->private_impl.f_code_lengths[wuffs_flate__code_order[v_i]] =
          ((uint8_t)((v_bits & 7)));
      v_bits >>= 3;
      v_n_bits -= 3;
      v_i += 1;
    ...
    while (v_i < 19) {
      self->private_impl.f_code_lengths[wuffs_flate__code_order[v_i]] = 0;
      v_i += 1;
    }
    WUFFS_BASE__COROUTINE_SUSPENSION_POINT(3);
    status = wuffs_flate__flate_decoder__init_huff(self, 0, 0, 19, 4095);
    if (status) {
      goto suspend;
    }
  ...
  label_0_continue:;
    ...
    label_1_break:;
      ...
      if (v_table_entry == 16) {
        v_n_extra_bits = 2;
        if (v_i <= 0) {
          status = WUFFS_FLATE__ERROR_BAD_HUFFMAN_CODE_LENGTH_REPETITION;
          goto exit;
        }
      ...
      while (v_rep_count > 0) {
        if (v_i >= (v_n_lit + v_n_dist)) {
          status = WUFFS_FLATE__ERROR_BAD_HUFFMAN_CODE_LENGTH_COUNT;
          goto exit;
        }
    ...
    if (self->private_impl.f_code_lengths[256] == 0) {
      status = WUFFS_FLATE__ERROR_MISSING_END_OF_BLOCK_CODE;
      goto exit;
    }
    WUFFS_BASE__COROUTINE_SUSPENSION_POINT(6);
    status = wuffs_flate__flate_decoder__init_huff(self, 0, 0, v_n_lit, 257);
    if (status) {
      goto suspend;
    }
    WUFFS_BASE__COROUTINE_SUSPENSION_POINT(7);
    status = wuffs_flate__flate_decoder__init_huff(self, 1, v_n_lit,
                                                   (v_n_lit + v_n_dist), 0);
    if (status) {
      goto suspend;
    }
...
static wuffs_flate__status wuffs_flate__flate_decoder__init_huff(
  ...
  if ((((uint32_t)(v_counts[0])) + a_n_codes0) == a_n_codes1) {
    status = WUFFS_FLATE__ERROR_NO_HUFFMAN_CODES;
    goto exit;
  }
  v_remaining = 1;
  v_i = 1;
  while (v_i <= 15) {
    ...
    if (v_remaining < ((uint32_t)(v_counts[v_i]))) {
      status = WUFFS_FLATE__ERROR_BAD_HUFFMAN_CODE_OVER_SUBSCRIBED;
      goto exit;
    }
  ...
  if (v_remaining != 0) {
    status = WUFFS_FLATE__ERROR_BAD_HUFFMAN_CODE_UNDER_SUBSCRIBED;
    goto exit;
  }
  ...
  while (true) {
    ...
    if (v_min_cl >= 9) {
      status = WUFFS_FLATE__ERROR_BAD_HUFFMAN_MINIMUM_CODE_LENGTH;
      goto exit;
    }
    v_min_cl += 1;
  }
  ...
  while (true) {
    ...
    if (v_cl > 9) {
      ...
      label_2_break:;
        ...
        v_redirect_key =
            (((uint32_t)(wuffs_flate__reverse8[v_redirect_key >> 1])) |
             ((v_redirect_key & 1) << 8));
    ...
    v_reversed_key =
        (((uint32_t)(wuffs_flate__reverse8[v_key >> 1])) | ((v_key & 1) << 8));
    ...
    if (v_symbol == 256) {
      ...
      if (a_which == 0) {
        v_value = (wuffs_flate__lcode_magic_numbers[v_symbol & 31] | v_cl);
      } else {
        v_value = (wuffs_flate__dcode_magic_numbers[v_symbol & 31] | v_cl);
      }
    } else {
      status =
          WUFFS_FLATE__ERROR_INTERNAL_ERROR_INCONSISTENT_HUFFMAN_DECODER_STATE;
      ...
      *b_wptr_dst++ = ((v_table_entry >> 8) & 255);
      ...
      if ((v_table_entry >> 31) != 0) {
        *b_wptr_dst++ = ((v_table_entry >> 8) & 255);
        ...
        status = WUFFS_FLATE__ERROR_BAD_HUFFMAN_CODE;
        goto exit;
      } else {
        status =
            WUFFS_FLATE__ERROR_INTERNAL_ERROR_INCONSISTENT_HUFFMAN_DECODER_STATE;
    ...
    while (true) {
      if (((uint64_t)(v_distance)) >
        ...
        if (self->private_impl.f_history_index < v_hdist) {
          status = WUFFS_FLATE__ERROR_BAD_DISTANCE;
          goto exit;
        }
        ...
        if (((uint64_t)(v_distance)) >
            ((uint64_t)(
                ((wuffs_base__slice_u8){
                    ...
                    .len))) {
          status = WUFFS_FLATE__ERROR_INTERNAL_ERROR_INCONSISTENT_DISTANCE;
          goto exit;
        }
      }
...
label_0_break:;
  while (v_n_bits >= 8) {
    ...
    if (b_rptr_src == b_rstart_src) {
      status = WUFFS_FLATE__ERROR_INVALID_I_O_OPERATION;
      goto exit;
    }
    b_rptr_src--;
  }
...
wuffs_flate__status wuffs_flate__zlib_decoder__decode(
  ...
  switch (coro_susp_point) {
    ...
    if (((v_x >> 8) & 15) != 8) {
      status = WUFFS_FLATE__ERROR_INVALID_ZLIB_COMPRESSION_METHOD;
      goto exit;
    }
    if ((v_x >> 12) > 7) {
      status = WUFFS_FLATE__ERROR_INVALID_ZLIB_COMPRESSION_WINDOW_SIZE;
      goto exit;
    }
    if ((v_x & 32) != 0) {
      status = WUFFS_FLATE__ERROR_TODO_UNSUPPORTED_ZLIB_PRESET_DICTIONARY;
      goto exit;
    }
    if ((v_x % 31) != 0) {
      status = WUFFS_FLATE__ERROR_INVALID_ZLIB_PARITY_CHECK;
      goto exit;
    }
    v_checksum = 0;
    while (true) {
      wuffs_base__writer1__mark(&a_dst, b_wptr_dst);
      {
        ...
        wuffs_flate__status t_2 = wuffs_flate__flate_decoder__decode(
      ...
      v_checksum = wuffs_flate__adler32__update(
  ...
  label_0_break:;
    ...
    if (v_checksum != t_4) {
      status = WUFFS_FLATE__ERROR_CHECKSUM_MISMATCH;
      goto exit;
    }
