...
#define wuffs_deflate__packageid 967230  // 0x000EC23E
...
#define WUFFS_DEFLATE__ERROR_BAD_HUFFMAN_CODE -1157040124  // 0xBB08F804
#define WUFFS_DEFLATE__ERROR_BAD_HUFFMAN_MINIMUM_CODE_LENGTH \
  -1157040123                                                     // 0xBB08F805
#define WUFFS_DEFLATE__ERROR_BAD_DISTANCE -1157040122             // 0xBB08F806
#define WUFFS_DEFLATE__ERROR_BAD_DISTANCE_CODE_COUNT -1157040121  // 0xBB08F807
#define WUFFS_DEFLATE__ERROR_BAD_FLATE_BLOCK -1157040120          // 0xBB08F808
...
#define WUFFS_DEFLATE__ERROR_NO_HUFFMAN_CODES -1157040112  // 0xBB08F810
...
typedef struct {
  ...
  struct {
    ...
    wuffs_deflate__flate_decoder f_flate;
...
void wuffs_zlib__decoder__initialize(wuffs_zlib__decoder* self,
  ...
  self->private_impl.magic = WUFFS_BASE__MAGIC;
  wuffs_deflate__flate_decoder__initialize(
  ...
  switch (coro_susp_point) {
    ...
    while (true) {
      wuffs_base__writer1__mark(&a_dst, b_wptr_dst);
      {
        ...
        wuffs_zlib__status t_2 = wuffs_deflate__flate_decoder__decode(
